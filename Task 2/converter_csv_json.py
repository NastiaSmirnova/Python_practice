...
def read_built_in(file): #функция чтения с использованием модулей import csv, import json
    jsonArray = []
...
def write_built_in(file,data): #функция записи с использованием модулей import csv, import json
